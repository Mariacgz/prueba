...
def agregar_producto():
    ...
    print(f"Datos recibidos: Código={codigo}, Descripción={descripcion}, Cantidad={cantidad}, Precio={precio}")
...
def modificar_producto(codigo):
    ...
    print(f"Datos recibidos: Código={codigo}, Nueva Descripción={nueva_descripcion}, Nueva Cantidad={nueva_cantidad}, Nuevo Precio={nuevo_precio}")
...
def eliminar_producto(codigo):
    print(f"Datos recibidos: Código={codigo}")
...
def agregar_carrito():
    ...
    print(f"Datos recibidos: Código={codigo}, Cantidad={cantidad}")
